...
class SpotRunner(object):
    def __init__(self, physics_dt, render_dt) -> None:
        ...
        asset_path = "Assets/Scenes/07f5b601ee.usda"
        prim.GetReferences().AddReference(asset_path)

        BASE_DIR = Path(__file__).resolve().parent.parent
        ASSET_DIR = "Assets/spot_robot/"
        policy_path = os.path.join(BASE_DIR, ASSET_DIR, "policies/spot_arm/models", "spot_arm_policy.pt")
        policy_params_path = os.path.join(BASE_DIR,  ASSET_DIR, "policies/spot_arm/params", "env.yaml")
        usd_path = os.path.join(BASE_DIR, ASSET_DIR, "spot_arm.usd")
        print("_____________________________")
        print("USD Path: ", usd_path)
        print("Policy Path: ", policy_path)
        print("Policy Params Path: ", policy_params_path)
