...
class SpotArmFlatTerrainPolicy(PolicyController):
    ...
    def forward(self, dt, command, manual_arm_control=False, arm_targets=None):
        ...
        """
        print(f"arm_targets : {arm_targets}")
        ...
        if self._policy_counter % self._decimation == 0:
            ...
            if self.manual_arm_control and self.manual_arm_targets is not None:
                ...
                print(f"default_arm_pos: {default_pos_array[self.arm_joint_indices]}")
                print(f"arm_target_deviation: {arm_target_deviation}")
                ...
                print(f"updated arm action: {self.action[self.arm_joint_indices]}")
        ...
        print(f"New full Action: {action.joint_positions}")
